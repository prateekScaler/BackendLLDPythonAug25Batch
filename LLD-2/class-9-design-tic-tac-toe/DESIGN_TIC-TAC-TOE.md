...
[TicTacToe](https://www.google.com/search?q=tic+tac+toe)
...
* There can be two players or at max N-1 players.
* Each player will be allotted a symbol.
* The symbol can be one of O and X OR if there are going to be N-1 players, players can choose their symbols.
